/* $Header: /usr/tmp/cvs2git/cvsroot-netbsd/src/sys/netiso/Attic/tp_driver.c,v 1.1 1993/04/09 12:01:30 cgd Exp $ */
/* $Source: /usr/tmp/cvs2git/cvsroot-netbsd/src/sys/netiso/Attic/tp_driver.c,v $ */
#ifndef lint
