/* $Header: /usr/tmp/cvs2git/cvsroot-netbsd/src/sys/netiso/Attic/tp_events.h,v 1.1 1993/04/09 12:01:32 cgd Exp $ */
/* $Source: /usr/tmp/cvs2git/cvsroot-netbsd/src/sys/netiso/Attic/tp_events.h,v $ */
struct tp_event {
	int ev_number;
