...
static char rcsid[] = "$Header: /usr/tmp/cvs2git/cvsroot-netbsd/src/libexec/crond/Attic/do_command.c,v 1.1.1.1 1993/03/21 09:45:37 cgd Exp $";
#endif

/* $Source: /usr/tmp/cvs2git/cvsroot-netbsd/src/libexec/crond/Attic/do_command.c,v $
 * $Revision: 1.1.1.1 $
 * $Log: do_command.c,v $
