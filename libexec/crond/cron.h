 ...
 *
 * $Header: /usr/tmp/cvs2git/cvsroot-netbsd/src/libexec/crond/Attic/cron.h,v 1.1.1.1 1993/03/21 09:45:37 cgd Exp $
 * $Source: /usr/tmp/cvs2git/cvsroot-netbsd/src/libexec/crond/Attic/cron.h,v $
 * $Revision: 1.1.1.1 $
 * $Log: cron.h,v $
